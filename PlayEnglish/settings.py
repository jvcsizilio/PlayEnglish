"""
Django settings for PlayEnglish project.
...
SECRET_KEY = 'u1)(d1tim2d&0s&2c)#_nlp44ljy$*o41^uyl!(w=f952&o5ry'
...
ROOT_URLCONF = 'PlayEnglish.urls'

WSGI_APPLICATION = 'PlayEnglish.wsgi.application'
